...
<script src="<%= Asset.url("/template/web/js/jquery-1.10.2.js")%>"></script>
<%--<script src="js/bootstrap.min.js"></script>--%>
<script src="<%= Asset.url("/template/web/js/bootstrap.min.js")%>"></script>
<%--<script src="js/plugins/metisMenu/jquery.metisMenu.js"></script>--%>
<script src="<%= Asset.url("/template/web/js/plugins/metisMenu/jquery.metisMenu.js")%>"></script>

<!-- Page-Level Plugin Scripts - Dashboard -->
<%--<script src="js/plugins/morris/raphael-2.1.0.min.js"></script>--%>
<script src="<%= Asset.url("/template/web/js/plugins/morris/raphael-2.1.0.min.js")%>"></script>
<%--<script src="js/plugins/morris/morris.js"></script>--%>
<script src="<%= Asset.url("/template/web/js/plugins/morris/morris.js")%>"></script>

<!-- SB Admin Scripts - Include with every page -->
<%--<script src="js/sb-admin.js"></script>--%>
<script src="<%= Asset.url("/template/web/js/sb-admin.js")%>"></script>

<!-- Page-Level Demo Scripts - Dashboard - Use for reference -->
<%--<script src="js/demo/dashboard-demo.js"></script>--%>
<script src="<%= Asset.url("/template/web/js/demo/dashboard-demo.js")%>"></script>
