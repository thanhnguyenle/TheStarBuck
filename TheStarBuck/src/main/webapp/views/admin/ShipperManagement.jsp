                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>Le Van A</td>
                                    <td>02314695872</td>
                                    <td class="center">Tp. Ho Chi Minh</td>
                                    <td>01/01/2020</td>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>Le Van B</td>
                                    <td>02313335872</td>
                                    <td class="center">Tp. Can Tho</td>
                                    <td>02/01/2020</td>
                                    <td class=" text-center">
                                        <a href="#" class="btn btn-danger" data-toggle="modal"
                                           data-target="#deleteObject">Delete</a>
                                        <a href="editshipper.html" target="_blank" class="btn btn-info">Edit</a>
                                    </td>
                                </tr>
                                <tr class="odd gradeX">
                                    <td>3</td>
                                    <td>Le Van C</td>
                                    <td>02314646320</td>
                                    <td class="center">Tp. Vung Tau</td>
                                    <td>03/01/2020</td>
                                    <td class=" text-center">
                                        <a href="<%=request.getContextPath()%>/deleteShipper?id=${item.id}" class="btn btn-danger" data-toggle="modal"
                                           data-target="#deleteObject">Delete</a>
