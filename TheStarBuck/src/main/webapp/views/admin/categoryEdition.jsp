                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="idCategory" value="ca0001" placeholder="Enter id">
                                    </div>
                                    <div class="form-group">
                                        <label>Name Category</label>
                                        <input class="form-control" name="nameCategory" value="Cafe" placeholder="Enter name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="modifiedBy"value="Nhu" placeholder="Enter create by">
                                    </div>
