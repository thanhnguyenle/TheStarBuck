              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="idFeedback" value="fe0001" placeholder="Enter id account">
                  </div>
                  <div class="form-group">
                    <label>Id account</label>
                    <input class="form-control" name="idAccount" value="ac0001" placeholder="Enter id account">
                  </div>
                  <div class="form-group">
                    <label>Id product</label>
                    <input class="form-control" name="idProduct" value="pr0001" placeholder="Enter id product">
                  </div>
                  <div class="form-group">
                    <label>Content</label>
                    <input class="form-control" name="contentAccount" value="content" placeholder="Enter phone">
                  </div>
                  <div class="form-group">
                    <label>Rate</label>
