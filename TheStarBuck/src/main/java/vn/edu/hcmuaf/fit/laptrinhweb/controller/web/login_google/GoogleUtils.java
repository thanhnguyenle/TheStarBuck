...
public class GoogleUtils {
    public static String getToken(final String code) throws ClientProtocolException,
            IOException{
    ...
    public static GoogleUserInformation getUserInfo(final String accessToken) throws ClientProtocolException,IOException{
      ...
      GoogleUserInformation googleUserInformation = new Gson().fromJson(response,GoogleUserInformation.class);
